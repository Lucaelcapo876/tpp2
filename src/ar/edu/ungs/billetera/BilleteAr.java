...
public class BilleteAr implements IBilletera {
	...
	public void agregarPersonaAutorizada(String cuitEmpresa, String dniAutorizado) {
	    ...
	    // Obtener la empresa y agregarle el DNI al HashSet<String>
    ...
    public String crearCuentaRegular(String dniUsuario, String alias) {
        ...
        CuentaRegular nuevaCuenta = new CuentaRegular(nuevoCvu, alias, 0.0);
	...
	public String crearCuentaPremium(String dniUsuario, String alias, double depositoInicial) {
	    ...
	    String nuevoCvu = Utilitarios.generarSiguienteCvu();
	    CuentaPremium nuevaCuenta = new CuentaPremium(nuevoCvu, alias, depositoInicial);
	...
	public String crearCuentaCorporativa(String dniUsuario, String alias, String cuitEmpresa) {
	    ...
	    String nuevoCvu = Utilitarios.generarSiguienteCvu();
	    CuentaCorporativa nuevaCuenta = new CuentaCorporativa(nuevoCvu, alias, 0.0, cuitEmpresa, dniUsuario);
